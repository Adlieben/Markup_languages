...
::: {layout="[[-1], [1], [-1]]"}
![](images/Musicdivide.PNG){fig-align="center" width="500"}
:::
...
::: {style="text-align: center;"}
<a href="https://www.instagram.com/oliverwoodmusic/reel/C77Ed7gOCOb/" target="_blank"> <img src="images/Oliver Wood.png" alt="Oliver Wood" style="width: 50%;"/> </a>
:::

::: {style="max-height: 300px; overflow-y: auto; font-size: 50%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;"}
